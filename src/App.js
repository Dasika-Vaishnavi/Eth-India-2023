...
async function uploadFile() {
  try {
    ...
    // The `false` indicates that you're uploading a single file.
    // Returns a CID (Content ID) for your file that you can use for PoDSI verification.
    const uploadResponse = await lighthouse.upload('Charcha/src/images/Itachi.jpeg', 'c422f887.9cb0dfa05b9f4b1ab775c688f9d9b923', false, dealParams); //apikey
...
// Call the uploadFile function when you want to upload a file.
uploadFile();
